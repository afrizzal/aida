...
interface PublicPageShellProps {
  ...
  maxWidth?: 640 | 720;
  /** Configured workspace display name (falls back to the organization name — see D-16). */
  brandName: string;
}
...
// Sparkles, text-[15px]) so unauthenticated visitors still feel the workspace brand.
export function PublicPageShell({ children, maxWidth = 640, brandName }: PublicPageShellProps) {
  return (
